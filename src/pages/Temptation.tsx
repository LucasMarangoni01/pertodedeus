  ...
  return (
    <div className="space-y-10 max-w-3xl mx-auto relative">
      ...
      <header className="space-y-4 text-center md:text-left">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/10 text-teal-400 font-bold text-xs uppercase tracking-widest border border-teal-500/20">
      ...
      <motion.div 
        ...
        className="relative overflow-hidden rounded-3xl p-8 md:p-10 border border-teal-500/30 bg-gradient-to-br from-teal-950/80 to-navy/80 shadow-2xl"
      >
        <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
          <Sun className="w-32 h-32" />
        </div>
        <div className="relative z-10 space-y-4">
          <h3 className="text-teal-400 font-bold uppercase tracking-widest text-xs">A Promessa de Escape</h3>
      ...
      <div className="flex flex-col items-center">
        ...
        <AnimatePresence>
          {showEmergency && (
            ...
            >
              <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6 space-y-4 text-center">
                 <p className="text-red-200 font-bold">Deus está com você neste exato segundo.</p>
                 <p className="text-sm border-l-2 border-red-500/50 pl-4 py-2 italic text-left max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-teal-400 font-bold text-sm">{checks.filter(Boolean).length}/4</span>
          </div>
          ...
          <div className="space-y-3 pt-2">
            {checklistItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className={cn("transition-colors", isChecked ? "text-teal-400" : "text-pearl/20")}>
                    {isChecked ? <CheckCircle className="w-6 h-6" /> : <div className="w-6 h-6 rounded-full border-2 border-current" />}
                  </div>
                  <div className="flex items-center gap-3">
                     <item.icon className={cn("w-4 h-4", isChecked ? "text-teal-400" : "opacity-50")} />
        ...
        {/* Timer & Reflexão */}
        <div className="space-y-6">
           <div className="bg-gradient-to-b from-navy/50 to-navy border border-teal-500/20 rounded-3xl p-8 text-center space-y-6 shadow-xl relative overflow-hidden">
             <div className="absolute -top-10 -right-10 opacity-5 pointer-events-none text-teal-400">
             ...
             <div className="text-6xl font-display font-light tracking-widest text-teal-400 relative z-10 py-4">
             ...
             <button 
               ...
               className={cn(
                 ...
                 isTimerRunning 
                   ...
                   : "bg-teal-500 text-navy hover:scale-105"
               )}
             >
           ...
           <div className="space-y-3">
              ...
              <textarea 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 h-32 resize-none outline-none focus:border-teal-500/50 transition-colors text-sm"
              />
           </div>
        </div>
      </div>
